...
var naverResources = require('./resources/Naver');
var codeResources = require('./resources/Codes');
...
var resources = {
  ...
  Benepia: require('./resources/Benepia'),
  Bank: codeResources.Banks,
  Card: codeResources.Cards,
  Cvs: require('./resources/Cvs'),
  KcpQuick: require('./resources/KcpQuick'),
  Naver: naverResources.Naver,
  NaverPayment: naverResources.NaverPayment,
  Partner: require('./resources/Partners'),
  Payco: require('./resources/Payco'),
  Receipt: require('./resources/Receipts'),
  Tier: require('./resources/Tiers'),
  User: require('./resources/Users'),
  Paymentwall: require('./resources/Paymentwall'),
};
